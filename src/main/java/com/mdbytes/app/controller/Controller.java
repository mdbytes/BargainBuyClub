...
import com.mdbytes.app.controller.events.*;
...
public class Controller extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            e.printStackTrace();
            Event event = new Event(request, response);
            event.handleException(request, response, "Something's gone wrong.  Contact system administrator.");
        }

            ...
            <div class="container">
                <div class="tab-content translations-content-item en visible" id="en">
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Application</strong> refers to BargainBuyClub, the software program provided by
                                the Company.</p>
                        </li>
                        <li>
                            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in
                                this Agreement) refers to BargainBuyClub.</p>
                        </li>
                        <li>
                            <p><strong>Country</strong> refers to: Iowa, United States</p>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>By email: martin@mdbytes.com</li>
                    </ul>
                </div>
            </div>
        </div>
